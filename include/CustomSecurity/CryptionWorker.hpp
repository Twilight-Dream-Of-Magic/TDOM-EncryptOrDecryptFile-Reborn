			...
			*/
			...
			public:
				...
				void UpdateState()
				{
					...
					//Original Plan:
					//RandomQuadWordMatrix = RandomQuadWordMatrix ⊕ (TransformedSubkeyMatrix ⊕ (LeftMatrix ⊕ RightMatrix))
			...
			public:
				...
				*/
				...
				)
				{
					...
					std::uint64_t RoundSubkey = TransformedRoundSubkeyMatrix(Row, Column);
					...
					//RoundSubkey = ((RoundSubkey & 0xAAAAAAAAAAAAAAAA) >> 1) | ((RoundSubkey & 0x5555555555555555) << 1);
